...
import {PACKET_SIZE,decodeTelemetry,altitudeFromPressure,sequenceGap,groupValid,samplesInWindow} from '../protocol.js';
...
test('limits trends to the final 60 seconds',()=>{const samples=[{received:39999},{received:40000},{received:99999},{received:100000},{received:100001}];assert.deepEqual(samplesInWindow(samples,100000).map(x=>x.received),[40000,99999,100000])});
